...
export function Gallery({ data }: GalleryProps) {
  ...
  return (
    <section
      ref={rootRef}
      id="gallery"
      className="relative scroll-mt-24 bg-[#12080c] px-6 py-28 text-[#fff5f7] sm:px-10 lg:px-16"
    >
              ...
              <Dialog>
                ...
                >
                  <figure>
                    ...
                    <figcaption className="mt-4 flex items-baseline justify-between gap-4 border-t border-[#f3b8c4]/15 pt-4">
                      <span className="font-[family-name:var(--font-display)] text-xl">
                        {item.caption ?? item.alt}
                      </span>
                      <span className="text-xs tracking-[0.2em] text-[#f3b8c4]/55 uppercase">
                        View
                      </span>
                    </figcaption>
                  </figure>
                ...
                <DialogContent className="max-w-3xl border-[#f3b8c4]/20 bg-[#140a0d] p-3 text-[#fff5f7] sm:max-w-3xl">
                  <DialogHeader className="px-2 pt-2">
                    <DialogTitle className="font-[family-name:var(--font-display)] text-xl text-[#fff5f7]">
                      {item.caption ?? item.alt}
                    </DialogTitle>
                    {item.credit ? (
